  ...
  async updateNavButtons() {
    ...
    if (user) {
      ...
      navButtons.innerHTML = `
        ...
        <span class="btn-auth" style="cursor: default; background-color: #4a5568; color: white; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 120px;">${user.username}</span>
